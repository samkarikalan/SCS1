  ...
  if (state.uniqueGamesMode && numResting > 0) {
    ...
    if (bestGame && bestScore > 0) {
      ...
      if (bestScore > currentBest) {
        ...
        // A fresher game may change who rests, but it must never make rest
        // distribution less fair. Pull the most-rested candidates back into
        // play first and replace them only with players who have rested no
        // more often.
